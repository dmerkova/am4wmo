...
dx['speed']=(dx.omfu*dx.omfu+dx.omfv*dx.omfv)**(1/2)
...
t2a=dx.groupby(["sid","lev"],as_index=False).agg({"speed":["count","mean","std"], "used":"sum"})
t2b=t2a.dropna()
t2b.to_csv('w'+aircraft+'.csv')
